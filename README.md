...
### 2️⃣ **AI Deepfake Detection**  
- **`app/src/main/java/com/example/sosbutton/DeepfakeDetector.kt`**  
  - Handles voice analysis using the Deepware API.  
...
### 4️⃣ **Configuration & Dependencies**  
- **`build.gradle.kts`**  
